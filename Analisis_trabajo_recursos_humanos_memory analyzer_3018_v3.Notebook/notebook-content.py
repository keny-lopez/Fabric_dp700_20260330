...
dataset = "Analisis_trabajo_recursos_humanos" # Enter the name or ID of the semantic model
workspace = "DP700" # Enter the workspace name or ID in which the semantic model exists
